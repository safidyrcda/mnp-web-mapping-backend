...
export class AutoMigration1781250925623 implements MigrationInterface {
    name = 'AutoMigration1781250925623'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."funding_fundingtype_enum" AS ENUM('funder', 'technical_partner', 'strategical_partner', 'technical_and_funder')`);
        await queryRunner.query(`ALTER TABLE "public"."funding" ADD "fundingType" "public"."funding_fundingtype_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."funding" DROP COLUMN "fundingType"`);
        await queryRunner.query(`DROP TYPE "public"."funding_fundingtype_enum"`);
    }
