...
export class AutoMigration1781262994753 implements MigrationInterface {
    name = 'AutoMigration1781262994753'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "public"."protected_area_funding" ADD "note" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."protected_area_funding" DROP COLUMN "note"`);
    }
