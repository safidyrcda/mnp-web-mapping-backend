...
export class AutoMigration1781464359377 implements MigrationInterface {
    name = 'AutoMigration1781464359377'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "public"."funder_funding" DROP CONSTRAINT "FK_9b5f2938c690aeed03e2bcff01b"`);
        await queryRunner.query(`ALTER TABLE "public"."funder_funding" DROP COLUMN "fundingId"`);
        await queryRunner.query(`ALTER TABLE "public"."protected_area_partner" ADD "funderId" uuid`);
        await queryRunner.query(`ALTER TABLE "public"."protected_area" ALTER COLUMN "geometry" TYPE geometry`);
        await queryRunner.query(`ALTER TABLE "public"."funding" ALTER COLUMN "fundingType" SET DEFAULT 'funder'`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."protected_area_partner" ADD CONSTRAINT "FK_e1bd04c6d4181d649eaed894a06" FOREIGN KEY ("funderId") REFERENCES "public"."funder"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."user_roles" DROP CONSTRAINT "FK_86033897c009fcca8b6505d6be2"`);
        await queryRunner.query(`ALTER TABLE "public"."user_roles" DROP CONSTRAINT "FK_472b25323af01488f1f66a06b67"`);
        await queryRunner.query(`ALTER TABLE "public"."protected_area_partner" DROP CONSTRAINT "FK_e1bd04c6d4181d649eaed894a06"`);
        await queryRunner.query(`ALTER TABLE "public"."users" ALTER COLUMN "id" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."user_roles" ADD CONSTRAINT "FK_86033897c009fcca8b6505d6be2" FOREIGN KEY ("roleId") REFERENCES "public"."roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "public"."funding" ALTER COLUMN "fundingType" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "public"."protected_area" ALTER COLUMN "geometry" TYPE geometry(GEOMETRY,0)`);
        await queryRunner.query(`ALTER TABLE "public"."protected_area_partner" DROP COLUMN "funderId"`);
        await queryRunner.query(`ALTER TABLE "public"."funder_funding" ADD "fundingId" uuid NOT NULL`);
