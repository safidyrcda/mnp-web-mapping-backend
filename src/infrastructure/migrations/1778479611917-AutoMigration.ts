...
export class AutoMigration1778479611917 implements MigrationInterface {
    name = 'AutoMigration1778479611917'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "public"."funding" ADD "description" text`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."funding" DROP COLUMN "description"`);
    }
